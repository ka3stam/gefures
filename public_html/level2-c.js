...
var Island = [[0, 0, 0, 0, 2], [3, 4, 4, 2, 0], [1, 1, 2, 0, 3]];
...
function drawIslandsAndBridges()
{
    ...
    if (counter === countB)
    {
        $(document).ready(function () {
            swal({
                title: "Φανταστικά!",
                text: "Μόλις ολοκλήρωσες και το επίπεδο 2",
                imageUrl: "trophy.jpg", allowOutsideClick: true,
...
var Solution = [2, 1, 2, 0, 0, 1, 1, 1, 1, 2];
